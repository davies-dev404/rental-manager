                      ...
                      <TabsContent value="smtp" className="space-y-4 mt-4 p-4 border rounded-md">
                          ...
                          <div className="flex justify-start pt-2">
                                <Button size="sm" onClick={() => {
                                    ...
                                    if (!newSettings.integrations) newSettings.integrations = {};
                                    if (!newSettings.integrations.email) newSettings.integrations.email = {};
                                    newSettings.integrations.email.provider = 'smtp';
                                    
                                    setSettings(newSettings);
                                    handleSave(); // Trigger save immediately
                                    toast({ title: "SMTP Activated", description: "SMTP is now your active email provider. If fields are empty, .env values will be used." });
                                }}>
                                    {t('activate_smtp') || "Activate & Save SMTP"}
                                </Button>
                          </div>
                      </TabsContent>
