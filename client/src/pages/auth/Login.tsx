...
export default function LoginPage() {
  ...
  const handleLogin = async (role: "admin" | "caretaker") => {
    setIsLoading(true);
    try {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 p-4">
      <div className="w-full max-w-md space-y-8">
        <div className="flex flex-col items-center text-center space-y-2">
            ...
            <h1 className="text-3xl font-heading font-bold text-gray-900 dark:text-white tracking-tight">RentalManager</h1>
        ...
        <Tabs defaultValue="admin" className="w-full">
          ...
          <TabsContent value="admin">
            <Card className="border-border shadow-lg">
              ...
              <CardFooter>
                <Button 
                  className="w-full h-11 text-base shadow-md transition-all hover:shadow-lg active:scale-[0.98]" 
